...
public class CameraController3 : Singleton<CameraController3>
{
	public CameraController3.CameraPreset ActivePreset { get; private set; }
	...
	{
		this.CamerasPreset.ForEach(delegate(CameraController3.CameraPreset c)
		{
	...
	[SerializeField]
	private List<CameraController3.CameraPreset> CamerasPreset = new List<CameraController3.CameraPreset>();
