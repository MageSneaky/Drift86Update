...
public class FreeCamera : MonoBehaviour
{
	private void Update()
	{
		...
		this.Velocity.y = Mathf.MoveTowards(this.Velocity.y, (float)(Input.GetKey(101) ? 1 : (Input.GetKey(113) ? -1 : 0)) * this.MoveSpeed * 0.3f, this.MoveAccelerationSpeed * Time.deltaTime);
